...
public class Publisher {
    ...
    public void setPublisherPhone(String publisherPhone) { this.publisherPhone = publisherPhone; }

    @Override
    public String toString() { return "(" +publisherId+ ") " +publisherName+
            " located at " +publisherAddress+ ". Phone #: " +publisherPhone ; }
}
